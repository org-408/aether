...
#[async_trait]
impl<E: PriorityMessage, Q: QueueReader<E> + QueueWriter<E>> QueueReader<E>
    for PriorityQueue<E, Q>
{
...
#[async_trait]
impl<E: PriorityMessage, Q: QueueReader<E> + QueueWriter<E>> QueueWriter<E>
    for PriorityQueue<E, Q>
{
