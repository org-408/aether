...
use crate::actor::context::{
    InfoPart, MessagePart, RootContext, SenderPart, SpawnerPart, StopperPart,
};
...
use crate::actor::typed_context::{
    TypedInfoPart, TypedMessagePart, TypedSenderContext, TypedSenderPart, TypedSpawnerContext,
...
impl TypedSpawnerPart for TypedRootContext {
    ...
    async fn spawn_prefix<A: Message + Clone>(
        ...
        TypedExtendedPid::new(
            self.inner
                .spawn_prefix(props.get_underlying().clone(), prefix)
                .await,
        )
    }
